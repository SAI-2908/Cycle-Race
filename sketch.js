...
mainCyclist.setCollider("rectangle", 0, 0, 1200,1400)
...
function draw() {
  ...
  textSize(23);
  fill(255);
  restart = text("Press Up Arrow to Restart the Game!",180,200 )
...
function pinkCyclists(){
        player1 =createSprite(500,Math.round(random(50, 250)));
        player1.scale =0.06;
...
function yellowCyclists(){
        player2 =createSprite(500,Math.round(random(50, 250)));
        player2.scale =0.06;
...
function redCyclists(){
        player3 =createSprite(500,Math.round(random(50, 250)));
        player3.scale =0.06;
